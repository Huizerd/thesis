...
\input{04_chapters/NPJR25/sec/1_intro}
\input{04_chapters/NPJR25/sec/4_method}
\input{04_chapters/NPJR25/sec/2_results}
\input{04_chapters/NPJR25/sec/3_discussion}
...
\newcommand\itemonenpjr{\item \qrcode[height=0.4in]{https://mavlab.tudelft.nl/all-eyes-no-imu-learning-flight-attitude-from-vision-alone}}

\begin{mylist_npjr}[leftmargin=*, align=left, leftmargin=2em, itemindent=0pt, labelsep=0pt, labelwidth=2em]
	\itemonenpjr\quad Project page: \url{https://mavlab.tudelft.nl/all-eyes-no-imu-learning-flight-attitude-from-vision-alone}
\end{mylist_npjr}
